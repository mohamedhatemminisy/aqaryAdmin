...
@section('index_route', route('properties.plans', $property_id))
@section('store_route', route('plans.store'))
                ...
                @foreach (config('translatable.locales') as $key => $locale)
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                        <div class="form-group">
                            <label>@lang('categories.title') - @lang('general.'.$locale)<span class="text-danger"> *
                                </span></label>
