...
@section('store_route', route('recipes.store'))
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[title]' }}" placeholder="@lang('recipes.title')" class="form-control  pl-5 min-h-40px @error($locale . '.title') is-invalid @enderror" value="{{ old($locale . '.title') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[image_alt]' }}" placeholder="@lang('recipes.image_alt')" class="form-control pl-5 min-h-40px @error($locale . '.image_alt') is-invalid @enderror" value="{{ old($locale . '.image_alt') }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="{{ $locale . '[ingredients]' }}" @error($locale . '.ingredients' ) is-invalid @enderror class="{{ $locale }}-kt-ckeditor-ingredients-5">{{ old($locale . '.ingredients') }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>@lang('recipes.instructions') - @lang('general.'.$locale)<span class="text-danger"> * </span></label>
                            <textarea name="{{ $locale . '[instructions]' }}" @error($locale . '.instructions' ) is-invalid @enderror class="{{ $locale }}-kt-ckeditor-instructions-5">{{ old($locale . '.instructions') }}</textarea>
                        </div>
                    </div>
                @endforeach
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('date') }}" placeholder="@lang('recipes.recipe_date')" name="date" class="form-control  @error('date') is-invalid @enderror" id="kt_datepicker_1" readonly="readonly">
                    </div>
                    <div class="form-group">
